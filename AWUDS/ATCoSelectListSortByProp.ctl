...
' ##REMARKS After move, reorders right list box in ascending alphanumeric order of _
          specified property.
  Dim j As Long         'index used in 1st to loop thru items in right list box
  Dim k As Long         'index used in 2nd to loop thru items in right list box
  Dim lstCnt            'number of items in right list box
  Dim tmpData() As Long 'array of ItemData properties of items in right list box
  Dim tmp() As String   'array of item names in right list box
...
' ##REMARKS After move, reorders left list box in ascending alphanumeric order of _
          specified property.
  Dim j As Long         'index used in 1st to loop thru items in left list box
  Dim k As Long         'index used in 2nd to loop thru items in left list box
  Dim lstCnt            'number of items in left list box
  Dim tmpData() As Long 'array of ItemData properties of items in left list box
  Dim tmp() As String   'array of item names in left list box
